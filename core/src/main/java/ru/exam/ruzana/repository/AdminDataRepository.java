...
public interface AdminDataRepository {
    ...
    PersonPrivateDataDto findById(Long personId);
    ...
    PersonPrivateDataDto findByEmail(String email);
    ...
    List<PersonPrivateDataDto> findAll();

    @Select("select * from person_data where disabled = true ;")
    List<PersonPrivateDataDto> findAllByDisabledIsTrue();

    @Select("select * from person_data where disabled = false ;")
    List<PersonPrivateDataDto> findAllByDisabledIsFalse();
